food = {
    "ผัดไทย 100 ปี": {
        ...
        "image": "https://raw.githubusercontent.com/fuengfah01/thayang-linebot/main/image/padthai1.jpg",
        "location": "ร้านผัดไทย 100 ปี | https://maps.google.com/?q=ผัดไทย+100+ปี+ท่ายาง"
    },
    "ข้าวแช่แม่เล็ก": {
        "description": "ข้าวแช่สูตรโบราณ หอมเย็นสดชื่น ทานคู่เครื่องเคียงแบบเพชรบุรี",
        "highlight": "เหมาะสำหรับอากาศร้อน รสชาติกลมกล่อม",
    ...
    "ทองม้วนแม่เล็ก": {
        "description": "ทองม้วนกรอบ หอมกะทิ หวานกำลังดี",
        "highlight": "ทำสดใหม่ทุกวัน กรอบอร่อย",
    ...
    "ขนมหม้อแกง": {
        "description": "ขนมหวานขึ้นชื่อของเพชรบุรี หอมไข่และน้ำตาลโตนด",
        "highlight": "เนื้อเนียน หวานมัน หอมเฉพาะตัว",
    ...
    "โรตี ชาชัก": {
        "description": "โรตีกรอบนอกนุ่มใน เสิร์ฟคู่ชาชักหอมมัน",
    ...
    "แกงคั่วหอยขม": {
        "description": "แกงคั่วรสเข้มข้น หอมเครื่องแกง ทานคู่ข้าวสวยร้อนๆ",
    ...
    "ปลาทูทอดน้ำปลา": {
        "description": "ปลาทูทอดกรอบ ราดน้ำปลาหอมๆ ทานกับข้าวสวย",
